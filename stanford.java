...
public void intermediate()  throws SQLException, ClassNotFoundException, InterruptedException
{
 ...
 insertIntoProduct="INSERT INTO SAMPLE1 SELECT WORD , COUNT (WORD) AS FREQUENCY , NOOFFILES FROM SAMPLE GROUP BY WORD , NOOFFILES ORDER BY FREQUENCY DESC";
                         ...
                         PreparedStatement stmt6 = db.conn.prepareStatement(insertIntoProduct, Statement.RETURN_GENERATED_KEYS);
                                stmt6.execute();
                        ...
                        {
                            db = new db();
                        insertIntoProduct="INSERT  INTO DEMO SELECT sample1.word, POLOTICAL.frequency as frequency1 , sample1.frequency as frequency2,POLOTICAL.nooffiles as nooffiles1, sample1.nooffiles as nooffiles2  FROM POLOTICAL INNER JOIN SAMPLE1 ON POLOTICAL.word=SAMPLE1.word";
                         PreparedStatement stmt7 = db.conn.prepareStatement(insertIntoProduct, Statement.RETURN_GENERATED_KEYS);
                                stmt7.execute();
                        ...
                        insertIntoProduct="INSERT INTO DEMO (WORD,FREQUENCY2,NOOFFILES2) SELECT * FROM SAMPLE1 WHERE WORD NOT IN (SELECT WORD FROM DEMO)";
                         PreparedStatement stmt8 = db.conn.prepareStatement(insertIntoProduct, Statement.RETURN_GENERATED_KEYS);
                                stmt8.execute();
                      ...
                      //  rs14.close();
                        insertIntoProduct="INSERT INTO DEMO (WORD,FREQUENCY1,NOOFFILES1) SELECT * FROM POLOTICAL WHERE WORD NOT IN (SELECT WORD FROM DEMO)";
                         PreparedStatement stmt9 = db.conn.prepareStatement(insertIntoProduct, Statement.RETURN_GENERATED_KEYS);
                                stmt9.execute();
                            
                        //ResultSet rs6 = db.runSql(insertIntoProduct);                                            
                        //rs6.close();
                        insertIntoProduct="INSERT INTO DEMO1 select  word,(frequency1 + frequency2) as frequency ,(nooffiles1 + nooffiles2) as nooffiles from demo ";
                         PreparedStatement stmt10 = db.conn.prepareStatement(insertIntoProduct, Statement.RETURN_GENERATED_KEYS);
                                stmt10.execute();
...
public void algorithm(String news )  throws SQLException, ClassNotFoundException, InterruptedException
{
    System.out.println(news);
    double TOTALNOOFFILES = 0;
     String file="C:\\Users\\AvinashKumarPrajapati\\Desktop\\"+news+".txt"; 
     try
     { BufferedReader br = new BufferedReader(new FileReader(file));
       ...
       // process the line.
          ...
          TOTALNOOFFILES=Integer.parseInt(line); 
            ...
            String insertIntoProduct=null;
            double t= 0;
                        insertIntoProduct="select * from "+news+"";
                         System.out.println(insertIntoProduct);
                        ...
                        while (rs16.next())
                        {
                          ...
                          //System.out.println("TF ="+TF);
                            double IDF1=TOTALNOOFFILES/NOOFFILES;
                            IDF = Math.log(IDF1);
                         ...
                         System.out.println("total TFIDF ="+t);
                        rs16.close();
...
public void initialise() throws SQLException
{
       ...
       PreparedStatement stmt = db.conn.prepareStatement(insertIntoProduct, Statement.RETURN_GENERATED_KEYS);
       stmt.execute();
       System.out.print("sdm");
       //ResultSet rs2 = db.runSql(insertIntoProduct);
      // rs2.close();
       insertIntoProduct="TRUNCATE TABLE SAMPLE1";
              PreparedStatement stmt1 = db.conn.prepareStatement(insertIntoProduct, Statement.RETURN_GENERATED_KEYS);
       stmt1.execute();
       System.out.print("sdm");
       //ResultSet rs3 = db.runSql1(insertIntoProduct);
       //rs3.close();
       insertIntoProduct="TRUNCATE TABLE DEMO";
              PreparedStatement stmt2 = db.conn.prepareStatement(insertIntoProduct, Statement.RETURN_GENERATED_KEYS);
       stmt2.execute();
       System.out.print("sdm");
       //ResultSet rs10 = db.runSql1(insertIntoProduct);
       //rs10.close();
       insertIntoProduct="TRUNCATE TABLE DEMO1";
       PreparedStatement stmt3 = db.conn.prepareStatement(insertIntoProduct, Statement.RETURN_GENERATED_KEYS);
       stmt3.execute();
       System.out.print("sdm");
        //ResultSet rs11 = db.runSql1(insertIntoProduct);
       //rs11.close();
   ...
   public void main1() throws SQLException, ClassNotFoundException, InterruptedException
   {
      ...
      try
      {
          String file="C:\\Users\\AvinashKumarPrajapati\\Desktop\\polotical.txt";
			...
			Synset[] synsets = database.getSynsets(wordForm);
                     ...
                     //System.out.println(s.toString());
                       ...
                       {  
                         ...
                         q++;
                                PreparedStatement stmt5 = db.conn.prepareStatement(insertIntoProduct, Statement.RETURN_GENERATED_KEYS);
                                stmt5.execute();
                                System.out.println("sdm"+x+u);
                          //ResultSet rs = db.runSql1(insertIntoProduct);
                            //rs.close();
              ...
              //System.out.print((char)ch);// ch contain character              
                        ...
                        
                        {
                         ...
                         //total no of files in thatcategory
...
public static void main(String[] args) throws IOException, Exception
    { main4(" telecom minister A Raja, DMK MP Kanimozhi and others in a money laundering case related to 2G spectrum allocation.");}
public static db db ;

public static void main4(String abc) throws IOException,
